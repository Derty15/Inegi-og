...
const URL =
  "https://www.inegi.org.mx/app/api/indicadores/desarrolladores/jsonxml/INDICATOR/6200002198/es/0700/true/BISE/2.0/b55cfc56-efff-64fa-7ab0-88938cd3d197?type=json";
    ...
    return new ImageResponse(
      <div style={{
        ...
        <div style={{display: 'flex', fontSize:32, textAlign:"center", maxWidth:700}}>
          Tasa de personas que considera insegura su entidad federativa (por cada 100 mil habitantes)
        </div>
